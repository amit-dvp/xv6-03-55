...
debug ?= false # to perform debug run this :  make debug = true
...
mkfs: mkfs.c fs.h
	gcc -Werror -Wall -ggdb -o mkfs mkfs.c
...
GDBPORT = $(shell expr `id -u` % 5000 + 25000)  # port to make gdb remote debugging
